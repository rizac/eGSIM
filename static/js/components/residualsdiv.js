...
//                                legendgroup: name, name: name, line: {color: this.colorMap.get(name)}};
        ...
        getAxis: function(divId, row, col, rows, cols){
            ...
            var xaxis = {mirror: true, zeroline: false, linewidth: 1, domain: xaxisdomain, anchor: `y${axisIndex}`};
            var yaxis = {mirror: true, zeroline: false, linewidth: 1, domain: yaxisdomain, anchor: `x${axisIndex}`};
