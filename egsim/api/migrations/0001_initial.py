# Generated by Django 3.2.9 on 2022-01-08 22:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration', models.DateTimeField(default=None, help_text='expiration date(time) after which the flatfile is not visible or accessible to any request. If null, the flatfile has no expiration date', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='RegionalizationDataSource',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text='Unique name', unique=True)),
                ('display_name', models.TextField(default=None, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='The name of the regionalization this region derives from', null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.regionalizationdatasource', to_field='name'),
        ),
        migrations.AddField(
            model_name='gsim',
            name='imts',
