# Generated by Django 4.1.5 on 2023-07-21 09:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text='Unique name', unique=True)),
                ('type', models.CharField(choices=[('rupture_parameter', 'Rupture parameter'), ('site_parameter', 'Site parameter'), ('distance_measure', 'Distance measure'), ('intensity_measure', 'Intensity measure'), ('unknown', 'Unknown')], default='unknown', help_text='The type of Column (e.g., IMT, OpenQuake parameter, distance measure)', max_length=17)),
                ('help', models.TextField(default='', help_text='Field help text')),
                ('dtype', models.TextField(help_text='The datat type of the column ("int", "bool", "datetime", "str" or "float", or list of possible values the column data can have)')),
            ],
            options={
                'abstract': False,
            },
