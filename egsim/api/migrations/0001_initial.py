# Generated by Django 4.1.5 on 2023-11-07 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hidden', models.BooleanField(default=False, help_text='Hide this item, i.e. make it publicly unavailable through the `objects` and `names`property and as such, to the whole API. This field is intended to hide/show items quickly from the admin panel without executing management scrips')),
