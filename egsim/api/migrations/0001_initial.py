    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hidden_in_browser', models.BooleanField(default=False, help_text='if true, the flatfile is hidden in browsers. If not expired, it is still accessible via normal API requests ')),
                ('expires_at', models.DateTimeField(default=None, help_text='expiration date(time) after which the flatfile is not visible or accessible to any request. If null, the flatfile has no expiration date', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.SmallIntegerField(choices=[(egsim.api.models.FlatfileColumn.CATEGORY['DISTANCE_MEASURE'], 'Distance measure'), (egsim.api.models.FlatfileColumn.CATEGORY['RUPTURE_PARAMETER'], 'Rupture parameter'), (egsim.api.models.FlatfileColumn.CATEGORY['SITE_PARAMETER'], 'Site parameter')], help_text='The OpenQuake category of the GSIM property associated to this column', null=True)),
                ('help', models.TextField(default='', help_text='Field help text')),
                ('properties', models.JSONField(decoder=egsim.api.models.DateTimeDecoder, encoder=egsim.api.models.DateTimeEncoder, help_text='column data properties as JSON (null: no properties). Optional keys: "dtype" ("int", "bool", "datetime", "str" or "float", or list of possible values the column can have), "bounds": [min or null, max or null] (null means: unbounded), "default" (the default when missing)', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('regionalization', models.TextField(help_text='The name of the regionalization defining the mapping Gsim <-> Geographic region')),
        ...
        migrations.AddField(
            model_name='gsim',
            name='trt',
            field=models.ForeignKey(help_text='Tectonic Region type', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gsims', to='api.gsimtrt'),
        ),
        migrations.AddIndex(
