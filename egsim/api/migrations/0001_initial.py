    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', models.JSONField(decoder=egsim.api.models.DateTimeDecoder, encoder=egsim.api.models.DateTimeEncoder, help_text='data properties as JSON (null: no properties). Optional keys: "dtype" ("int", "bool", "datetime", "str" or "float"), "bounds": [min or null, max or null] (null means: unbounded), "default" (the default when missing) and "choices" (list of possible values the column can have)', null=True)),
            ],
            options={
                'abstract': False,
            },
