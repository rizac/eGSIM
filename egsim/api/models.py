...
class Gsim(_UniqueNameModel):
    ...
    # def asjson(self) -> tuple[str, tuple[str], str]:   # FIXME REMOVE
    #     """Convert this object as a JSON-serializable tuple of strings:
    #     (gsim:str, imts:list[str], warning:str) where arguments are all
    #     strings except 'imts' which is a tuple of strings
    #     """
    #     imts = (_.name for _ in self.imts.all())  # noqa
    #     return self.name, tuple(imts), self.warning or ''  # noqa
...
# =============================================================================
# Utilities:  FIXME REMOVE COMMENTED LINES BELOW
# =============================================================================
